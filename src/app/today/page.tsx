  ...
  return (
    <main className="page-shell space-y-8">
      ...
      <FortuneRevealGate
        ...
        title="12星座ランキングを開く"
        description="ランキングと各星座の詳しい運勢は、星の読み込み演出のあとに表示します。"
        buttonLabel="今日のランキングを見る"
        readingLabel="12星座の流れを読んでいます..."
        variant="daily"
      >
        <section>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_300px]">
          <section className="grid gap-4">
            {fortunes.map((fortune) => {
              const sign = zodiacSigns.find((item) => item.slug === fortune.sign);
              return (
                <article key={fortune.sign} className="rounded-lg bg-white/88 p-5 shadow-soft">
